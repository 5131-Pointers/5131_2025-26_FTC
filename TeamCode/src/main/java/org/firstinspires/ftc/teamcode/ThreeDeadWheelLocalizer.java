...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1915.1283257429725; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1868.9195496908242; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 2905.102518969138; // x position of the perpendicular encoder (in tick units)
    }
